    ...
    public sealed partial class RouteSelectionPage : Page
    {
        ...
        private async void ApplyButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (_selectedRoute == 1)
            {
                ...
                selectedRoute = await FileIO.FullRouteIO.LoadRouteAsync(FileIO.FullRouteIO.LoadRoute(FileIO.FullRouteIO.HistoricalKilometerFileName));
            }
            else //choose blind walls route
            {
                selectedRoute = await FileIO.FullRouteIO.LoadRouteAsync(FileIO.FullRouteIO.LoadRoute(FileIO.FullRouteIO.BlindWallsFileName));
            }
